...
### Step 1. Create `.env` file and add `mockforme` Access Token
...
<br /><br />
# Insights, What We Changed for MockForMe Integration
...
- Import `mockforme-client` and `mockforme-server` in layout.js <br />
...
- Inside `src/app/page.js` get product data and pass to ProductList component <br />
  ```
